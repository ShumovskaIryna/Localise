...
const translationsEn = {
  ...
  "sample-text": "Hello Mr. <bold><italic>Panda</italic></bold>.",
...
const translationsUa = {
  ...
  "sample-text": "Привіт пане <bold><italic>Панда</italic></bold>.",
    ...
    <Suspense fallback={"Loading..."}>
      <div className="App">
        <header className="App-header">
          ...
          {/* <button name="language" onChange={onChange} value="en">
            English
          </button>
          <button name="language" onChange={onChange} value="ua">
            Українська
          </button> */}
